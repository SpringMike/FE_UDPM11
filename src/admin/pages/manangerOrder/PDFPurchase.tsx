...
const PDFPurchase = ({ invoice, createDate, importDate, fullName, phoneNumber }: Props) => {
    Font.register({
        family: "Roboto",
        src:
    ...
    const SupplierInfo = ({ phoneNumber, fullName }: any) => (
    ...
    const InvoiceTableHeader = () => (
        <View style={stylesTableHeader.container}>
            ...
            <Text style={stylesTableHeader.amount}>Giá tiền</Text>
        </View>
    );
    ...
    const InvoiceTableFooter = ({ items }: any) => {
        ...
        return (
            <div>
                ...
                <View style={stylesTableFooter.row}>
                    <Text style={stylesTableFooter.description}>Tổng giá</Text>
                    <Text style={stylesTableFooter.total}>{totalQty}</Text>
                </View>
            </div>
    ...
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                <InvoiceTitle title='Phiếu mua hàng' />
