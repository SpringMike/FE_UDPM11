...
import {getStatisticsImport, getStatisticsImportExtend, getStatisticsInventory} from "../../service/StatisticsService";
...
const Statistics: FC = () => {
            ...
            return (
                <>
                    <Grid item xs={12}>
                        ...
                        {statisticsType == 2 ?
                            <Antd.Form.Item label={'Mã sản phẩm cụ thể: '} labelCol={{span: 6}} labelAlign={'left'}>
                                <Antd.Input width={'100%'} placeholder="Nhập mã sản phẩm"
                                            defaultValue={filter.keySearch} onChange={(e) => {
                                    filter.keySearch = e.target.value
                                }}></Antd.Input>
                            </Antd.Form.Item> : null

                        }
                        <StatisticTypeOptions title="Kiểu xem: " data={ViewTypeOptions} initValue={filter.viewType}
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <Antd.Form.Item label={'Sắp xếp theo: '} name={'sortBy'} style={{width: '100%'}}
                                    ...
                                    <SelectSortby initValue={filter.sortBy} sortOptions={ImportSortOptions}
                                                  onChange={onSortByChange}></SelectSortby>
                                </Antd.Form.Item>

                            </Grid>
                            <Grid item xs={12}>
                                <Antd.Form.Item label={'Top: '} name={'size'} labelCol={{span: 6}} labelAlign={'left'}>
                                    <Antd.InputNumber style={{width: '100%'}} defaultValue={filter.size}
                                                      onChange={(value: any) => filter.size = value}
                                                      placeholder="Nhập số lượng"></Antd.InputNumber>
                                </Antd.Form.Item>
                            </Grid>
                            <Grid item xs={12}>

                                <Antd.Form.Item label={'Xắp xếp: '} name={'sortDir'} style={{width: '100%'}}
                                                labelAlign='left' labelCol={{span: 6}}>
                                    <Antd.Switch defaultChecked={sortDir} onChange={(check, e) => {
                    ...
                    <Grid item xs={12}>
                        <Grid container spacing={2}>
                            <Grid item xs={12}>
                                <SelectInventory initValue={filter.inventoryId} onChange={(id: number) => {
                    ...
                    <Grid item xs={12}>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <Antd.Form.Item label={'Sắp xếp theo: '} name={'sortBy'} style={{width: '100%'}}
                                                labelAlign='left' labelCol={{span: 6}}>
                                    <SelectSortby initValue={filter.sortBy} sortOptions={InventorySortOptions}
                                                  onChange={onSortByChange}></SelectSortby>
                                </Antd.Form.Item>
                            ...
                            <Grid item xs={12}>
                                ...
                                <Antd.Form.Item label={'Xắp xếp: '} name={'sortDir'} style={{width: '100%'}}
                                                labelAlign='left' labelCol={{span: 6}}>
                                    <Antd.Switch defaultChecked={filter.sortDir} onChange={(check, e) => {
                                        filter.sortDir = check
                                        setSortDir(check)
                                    }}></Antd.Switch>
        ...
        return (
            ...
            >
                <Antd.Form onFinish={onSubmitFilter}>
                    <Grid item xs={12}>
                        <StatisticTypeOptions title="Thống kê: " data={TypeOptions} initValue={filter.type}
                                              onChange={(value: number) => {
                                                  filter.type = value
                                                  switch (value) {
                                                      case 1:
                        ...
                        <StatisticTypeOptions title="Kiểu thống kê: " data={InventoryTypeOption}
                                              initValue={filter.statisticsType} onChange={(value: number) => {
                            switch (value) {
                                case 1:
                                    filter.keySearch = ''
                                    break;
    ...
    return (
        <>
                        ...
                        filterProps.type == 1 ? <div className='p-5' style={{width: '100%'}}>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={4.5} container spacing={2}>
                                    <Grid item xs={12}>
                                        <Paper style={{height: 290}}>
                                            <CardDetails filter={filterProps} loadding={loadding} imports={imports}
                                                         stokes={stokes}></CardDetails>
                                        </Paper>
                                    ...
                                    <Grid item xs={12}>
                                        <Paper style={{height: 290, width: '100%'}}>
                                            {imports ? <PieChartReturnImport imports={imports} stokes={[]}
                                                                             filter={filter}></PieChartReturnImport> : null}
                                        </Paper>
                                    </Grid>
                                ...
                                <Grid item xs={12}>
                                    ...
                                    <Antd.Button
                                        style={{width: '150px', fontSize: '14px', marginRight: 20, marginLeft: 0}}
                                ...
                                <Grid item xs={12}>
                                    {filterProps.viewType == 1 ?
                                        <ImportStatisticNomal imports={imports} onChange={() => {
                                        }}></ImportStatisticNomal> :
                                        <ImportStatisticExtend imports={imports} onChange={() => {
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={4} container spacing={2}>
                                    ...
                                    <Grid item xs={12}>
                                        <Paper style={{height: 300, width: '100%'}}>
                                            {imports ? <PieChartReturnImport imports={imports} stokes={stokes}
                                                                             filter={filter}></PieChartReturnImport> : null}
                                        </Paper>
                                    </Grid>
                                ...
                                <Grid item xs={8}>
                                    <Paper style={{borderRadius: 5, height: 620, width: '100%', padding: 20}}>
                                        {stokes?.length > 0 ? <BarChartStatisticInventory
                                                inventoryStatistic={stokes}></BarChartStatisticInventory> :
                                            <div style={{display: 'flex', justifyContent: 'center'}}>
                                ...
                                <Grid item xs={12}>
                                    <InventoryStatisticTable data={stokes} onChange={() => {
            ...
            <Antd.Button style={{right: 0, width: 40, height: 50, top: '45%', position: 'fixed', zIndex: 10}}
                         type={'primary'}
